...
public class GameController {
	...
	public ResponseEntity<ApiResponse<GameResponse>> createGame(
		...
		GameResponse response = gameService.createGame(workspace, request);
	...
	public ResponseEntity<ApiResponse<List<GameResponse>>> getGamesByWorkspace(
		...
		workspaceService.getWorkspaceEntity(workspaceUuid);
		List<GameResponse> responses = gameService.getGamesByWorkspace(workspaceUuid);
	...
	public ResponseEntity<ApiResponse<GameResponse>> updateGame(
		...
		GameResponse response = gameService.updateGame(gameUuid, request);
		return ResponseEntity.ok(ApiResponse.of(response));
	}
	...
	public ResponseEntity<Void> deleteGame(
			@Parameter(description = "게임 UUID") @PathVariable UUID gameUuid) {
		gameService.deleteGame(gameUuid);
