...
public record TestActionResponse(
	...
	@Schema(description = "리소스 상태", example = "ACTIVE") @JsonProperty("status")
	String status,

	@Schema(description = "현재 용량", example = "5") @JsonProperty("current_capacity")
	Integer currentCapacity,

	@Schema(description = "응답 메시지", example = "인스턴스 준비 중입니다.") @JsonProperty("message")
	String message) {
