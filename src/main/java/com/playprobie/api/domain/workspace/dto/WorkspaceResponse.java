...
public record WorkspaceResponse(
	...
	@Schema(description = "워크스페이스 이름", example = "My Game Studio") @JsonProperty("name")
	String name,

	@Schema(description = "프로필 이미지 URL", example = "https://example.com/image.png") @JsonProperty("profile_image_url")
	String profileImageUrl,

	@Schema(description = "워크스페이스 설명", example = "인디 게임 개발 스튜디오") @JsonProperty("description")
	String description,

	@Schema(description = "게임 개수", example = "3") @JsonProperty("game_count")
	Integer gameCount,
