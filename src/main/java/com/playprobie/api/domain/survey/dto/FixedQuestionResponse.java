...
public record FixedQuestionResponse(
		...
		@Schema(description = "질문 내용", example = "게임 그래픽은 어떠셨나요?") @JsonProperty("q_content") String qContent,

		@Schema(description = "질문 순서", example = "1") @JsonProperty("q_order") Integer qOrder,
