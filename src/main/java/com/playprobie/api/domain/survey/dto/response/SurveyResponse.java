...
public record SurveyResponse(
	...
	@Schema(description = "설문 이름", example = "출시 전 테스트 설문") @JsonProperty("survey_name")
	String surveyName,
	...
	@Schema(description = "설문 종료 시간", example = "2024-01-31T18:00:00+09:00", type = "string") @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:ssXXX", timezone = "Asia/Seoul") @JsonProperty("ended_at")
	OffsetDateTime endedAt,

	@Schema(description = "테스트 목적 코드", example = "BALANCE_TEST") @JsonProperty("test_purpose")
	String testPurpose,
	...
	@Schema(description = "테스트 단계", example = "OBT") @JsonProperty("test_stage")
	String testStage,

	@Schema(description = "테마 우선순위", example = "[\"GRAPHICS\", \"GAMEPLAY\"]") @JsonProperty("theme_priorities")
	List<String> themePriorities,

	@Schema(description = "테마 상세 내용") @JsonProperty("theme_details")
	Map<String, List<String>> themeDetails,

	@Schema(description = "버전 노트", example = "v1.0.2 밸런스 패치 적용") @JsonProperty("version_note")
	String versionNote) {
