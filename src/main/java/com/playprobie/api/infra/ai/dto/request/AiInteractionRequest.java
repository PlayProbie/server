...
public record AiInteractionRequest(
		...
		@Schema(description = "설문 ID", example = "123") @JsonProperty("survey_id") Long surveyId,

		@Schema(description = "현재 질문 순서", example = "3") @JsonProperty("current_question_order") Integer currentQuestionOrder,

		@Schema(description = "전체 질문 수", example = "5") @JsonProperty("total_questions") Integer totalQuestions) {
